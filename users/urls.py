...
urlpatterns = [
    ...
    path('profile/subscribe/<int:user_id>/', Subscribe.as_view(), name='profile_subscribe'),
    path('profile/unsubscribe/<int:user_id>/', Unsubscribe.as_view(), name='profile_unsubscribe'),
